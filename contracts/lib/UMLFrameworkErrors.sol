...
library UMLFrameworkErrors {
    ...
    error UMLPolicyFrameworkManager__CommercialDisabled_CantAddMintingFee();
    error UMLPolicyFrameworkManager__CommercialDisabled_CantAddMintingFeeToken();
    error UMLPolicyFrameworkManager__CommecialEnabled_MintingFeeTokenRequired();
}
